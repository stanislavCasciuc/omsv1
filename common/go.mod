module github.com/stanislavCasciuc/common

go 1.22.6

require (
	google.golang.org/grpc v1.66.0 // direct
	google.golang.org/protobuf v1.34.1 // direct
)
...
require (
	...
	github.com/hashicorp/consul v1.19.2 // indirect
